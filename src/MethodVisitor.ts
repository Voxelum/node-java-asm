...
export abstract class MethodVisitor {
     ...
     * calls. May be null.
     */
    public constructor(api: number, mv: MethodVisitor = null) {
        this.api = 0;
    ...
    public visitInvokeDynamicInsn(name: string, desc: string, bsm: Handle, ...bsmArgs: any[]) {
        if (this.mv != null) {
            (this['__jswref_0'] = this.mv).visitInvokeDynamicInsn.apply(this['__jswref_0'], [name, desc, bsm].concat(<any[]>bsmArgs));
        }
    }
    ...
    public visitTableSwitchInsn(min: number, max: number, dflt: Label, ...labels: Label[]) {
        if (this.mv != null) {
            (this['__jswref_1'] = this.mv).visitTableSwitchInsn.apply(this['__jswref_1'], [min, max, dflt].concat(<any[]>labels));
        }
    }
